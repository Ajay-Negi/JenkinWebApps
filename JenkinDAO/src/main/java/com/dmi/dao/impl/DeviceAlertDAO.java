 ...
 */
@Repository
public class DeviceAlertDAO implements IDeviceAlertDAO {

	@PersistenceContext
	EntityManager entityManager;
	
	private static final Logger LOG = Logger.getLogger(DeviceAlertDAO.class);
	...
	public List<Alert> getByDeviceId(String deviceId) {
		...
		try{
			...
			String queryStr = "SELECT alert FROM Alert alert where LOWER(alert.deviceBean.id) = :deviceId";
	...
	public void delete(String deviceId) {
		...
		String queryStr = "DELETE from Alert alert where LOWER(alert.deviceBean.id)= :id";
